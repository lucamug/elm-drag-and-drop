...
var author$project$Main$Clock = {$: 'Clock'};
var author$project$Main$ClockJapan = {$: 'ClockJapan'};
var author$project$Main$Dashboard = {$: 'Dashboard'};
var author$project$Main$DragState = {$: 'DragState'};
	...
	return _Utils_Tuple2(
		{
			components: _List_fromArray(
				[
					{
					content: author$project$Main$ClockJapan,
					id: 'Comp. 4',
					...
					{
					content: author$project$Main$Clock,
					id: 'Comp. 3',
					location: author$project$Main$Menu,
					position: A2(
						author$project$Main$Position,
					...
					{
					content: author$project$Main$Star,
					id: 'Comp. 1',
					location: author$project$Main$Menu,
					position: A2(
						author$project$Main$Position,
					...
					{
					content: author$project$Main$DragState,
					id: 'Comp. 2',
					location: author$project$Main$Menu,
					position: A2(
						author$project$Main$Position,
			...
			dragStartPosition: elm$core$Maybe$Nothing,
...
var author$project$Main$subscriptions = function (_n0) {
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				A2(zaboco$elm_draggable$Draggable$subscriptions, author$project$Main$DragMsg, drag),
				A2(elm$time$Time$every, 1000, author$project$Main$Tick)
			]));
};
var author$project$Main$OnClick = function (a) {
	return {$: 'OnClick', a: a};
};
var author$project$Main$OnDragBy = function (a) {
	return {$: 'OnDragBy', a: a};
};
var author$project$Main$OnDragEnd = {$: 'OnDragEnd'};
var author$project$Main$OnDragStart = function (a) {
	return {$: 'OnDragStart', a: a};
};
var author$project$Main$OnMouseDown = function (a) {
...
var zaboco$elm_draggable$Internal$defaultConfig = {
	...
	onDragBy: function (_n1) {
		return elm$core$Maybe$Nothing;
	},
	onDragEnd: elm$core$Maybe$Nothing,
	onDragStart: function (_n2) {
		return elm$core$Maybe$Nothing;
	},
	onMouseDown: function (_n3) {
		return elm$core$Maybe$Nothing;
	}
};
...
var zaboco$elm_draggable$Draggable$Events$onMouseDown = F2(
	function (toMsg, config) {
		return _Utils_update(
			config,
			{
				onMouseDown: A2(elm$core$Basics$composeL, elm$core$Maybe$Just, toMsg)
			});
	});
var author$project$Main$dragConfig = zaboco$elm_draggable$Draggable$customConfig(
	_List_fromArray(
		[
			...
			zaboco$elm_draggable$Draggable$Events$onClick(author$project$Main$OnClick),
	...
	function (components, id) {
		var temp = elm$core$List$head(
			A2(
				...
				function (component_) {
					return _Utils_eq(component_.id, id);
				},
				components));
		if (temp.$ === 'Just') {
...
var author$project$Main$isDragging = function (model) {
	var _n0 = model.draggedComponent;
	if (_n0.$ === 'Just') {
		return true;
	} else {
		return false;
...
var author$project$Main$labelEmpty = 'empty';
var author$project$Main$positionToId = F2(
	function (label, _n0) {
		var x = _n0.x;
		var y = _n0.y;
		return label + ('_' + (elm$core$String$fromInt(x) + ('_' + elm$core$String$fromInt(y))));
	});
	...
	if (author$project$Main$isDragging(model)) {
		var id = F2(
			function (x, y) {
				return elm$core$Maybe$Just(
					A2(
						author$project$Main$positionToId,
		...
		return _Utils_eq(
			...
			A2(id, 1, 1)) ? A4(empty, 1, 1, 2, 1) : ((_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 2, 1)) || _Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 3, 1))) ? A4(empty, 2, 1, 2, 1) : (_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 1, 2)) ? A4(empty, 1, 2, 2, 1) : ((_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 2, 2)) || _Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 3, 2))) ? A4(empty, 2, 2, 2, 1) : (_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 0, 3)) ? A4(empty, 0, 3, 2, 1) : (_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 1, 3)) ? A4(empty, 1, 3, 2, 1) : (_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 2, 3)) ? A4(empty, 2, 3, 2, 1) : ((_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 3, 3)) || _Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 4, 3))) ? A4(empty, 3, 3, 2, 1) : elm$core$Maybe$Nothing)))))))) : (_Utils_eq(
			component.size,
			A2(author$project$Main$Size, 2, 2)) ? ((_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 1, 1)) || (_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 2, 1)) || (_Utils_eq(
			...
			A2(id, 2, 2)) || _Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 1, 2))))) ? A4(empty, 1, 1, 2, 2) : ((_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 3, 1)) || _Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 3, 2))) ? A4(empty, 2, 1, 2, 2) : ((_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 1, 3)) || _Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 2, 3))) ? A4(empty, 1, 2, 2, 2) : (_Utils_eq(
			model.idComponentWithMouseOver,
			A2(id, 3, 3)) ? A4(empty, 2, 2, 2, 2) : elm$core$Maybe$Nothing)))) : elm$core$Maybe$Nothing);
	} else {
		return elm$core$Maybe$Nothing;
	}
};
...
var zaboco$elm_draggable$Internal$updateAndEmit = F3(
	function (config, msg, drag) {
		var _n0 = _Utils_Tuple2(drag, msg);
		_n0$5:
		while (true) {
			switch (_n0.a.$) {
				case 'NotDragging':
					if (_n0.b.$ === 'StartDragging') {
						var _n1 = _n0.a;
						var _n2 = _n0.b;
						var key = _n2.a;
						var initialPosition = _n2.b;
						return _Utils_Tuple2(
				...
				default:
					switch (_n0.b.$) {
						case 'DragAt':
							var oldPosition = _n0.a.a;
							var newPosition = _n0.b.a;
							return _Utils_Tuple2(
...
var zaboco$elm_draggable$Draggable$updateDraggable = F3(
	function (_n0, _n1, _n2) {
		...
		var msg = _n1.a;
		var drag = _n2.a;
		var _n3 = A3(zaboco$elm_draggable$Internal$updateAndEmit, config, msg, drag);
		var newDrag = _n3.a;
		var newMsgMaybe = _n3.b;
		return _Utils_Tuple2(
...
var zaboco$elm_draggable$Draggable$update = F3(
	function (config, msg, model) {
		var _n0 = A3(zaboco$elm_draggable$Draggable$updateDraggable, config, msg, model.drag);
		var dragState = _n0.a;
		var dragCmd = _n0.b;
		return _Utils_Tuple2(
			_Utils_update(
		...
		switch (msg.$) {
			...
			case 'RemoveComponent':
				...
				var components = A2(
					elm$core$List$filter,
					function (component) {
						return !_Utils_eq(component.id, id);
					},
					model.components);
				return _Utils_Tuple2(
					_Utils_update(
					...
					elm$core$Platform$Cmd$none);
			case 'MouseEnterComponent':
				var id = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							idComponentWithMouseOver: elm$core$Maybe$Just(id)
						}),
					elm$core$Platform$Cmd$none);
			case 'MouseLeaveComponent':
				var id = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'OnDragBy':
				...
				var components = function () {
					var _n2 = model.draggedComponent;
					if (_n2.$ === 'Just') {
						var draggingComponent = _n2.a;
						return A2(
							elm$core$List$map,
							function (component) {
								return _Utils_eq(component.id, draggingComponent.id) ? _Utils_update(
									component,
									{
										position: {
											x: component.position.x + elm$core$Basics$round(dx),
											y: component.position.y + elm$core$Basics$round(dy)
										}
									}) : component;
							},
							model.components);
			...
			case 'OnDragStart':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							draggedComponent: elm$core$Maybe$Just(component)
						}),
					elm$core$Platform$Cmd$none);
			case 'OnDragEnd':
				var idDraggedComponent = function () {
					var _n5 = model.draggedComponent;
					if (_n5.$ === 'Just') {
						var draggedComponent = _n5.a;
						return draggedComponent.id;
					} else {
						return '';
					}
				}();
				...
				var components2 = function () {
					...
					if (_n4.$ === 'Just') {
						...
						return A2(
							elm$core$List$cons,
							{content: xxx.content, id: 'new', location: author$project$Main$Dashboard, position: overlay.position, size: overlay.size},
							components1);
					} else {
						return components1;
					}
				}();
				var components3 = function () {
					var _n3 = model.draggedComponent;
					if (_n3.$ === 'Just') {
						var draggedComponent = _n3.a;
						return A2(
							elm$core$List$map,
							function (component) {
								return _Utils_eq(component.id, draggedComponent.id) ? _Utils_update(
									component,
									{
										position: A2(author$project$Main$Position, draggedComponent.position.x, draggedComponent.position.y)
									}) : component;
							},
							components2);
					} else {
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{components: components3, draggedComponent: elm$core$Maybe$Nothing}),
					elm$core$Platform$Cmd$none);
			case 'OnClick':
				var id = msg.a;
				return _Utils_Tuple2(
...
var author$project$Main$MouseLeaveComponent = function (a) {
	return {$: 'MouseLeaveComponent', a: a};
};
...
var author$project$Main$attrsMouseInteraction = function (component) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$htmlAttribute(
			elm$html$Html$Events$onMouseEnter(
				author$project$Main$MouseEnterComponent(component.id))),
			mdgriffith$elm_ui$Element$htmlAttribute(
			elm$html$Html$Events$onMouseLeave(
				author$project$Main$MouseLeaveComponent(component.id)))
		]);
};
...
var author$project$Main$attrsPosition = function (component) {
	return _List_fromArray(
		[
			mdgriffith$elm_ui$Element$moveRight(component.position.x),
			mdgriffith$elm_ui$Element$moveDown(component.position.y)
		]);
};
...
var author$project$Main$viewComponentAsEmptyArea = F2(
			...
			A2(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							author$project$Main$attrsMouseInteraction(component),
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Border$color(
									(_Utils_eq(
										model.idComponentWithMouseOver,
										elm$core$Maybe$Just(component.id)) && author$project$Main$debug) ? A4(mdgriffith$elm_ui$Element$rgba, 0.6, 0.8, 0.8, 1) : A4(mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0))
								])))),
...
var author$project$Main$viewComponentAsOverlay = F2(
	function (model, component) {
		return mdgriffith$elm_ui$Element$inFront(
			A2(
				mdgriffith$elm_ui$Element$el,
...
var author$project$Main$RemoveComponent = function (a) {
	return {$: 'RemoveComponent', a: a};
};
var author$project$Main$isComponentDragging = F2(
	function (model, id) {
		var _n0 = model.draggedComponent;
		if (_n0.$ === 'Just') {
			var draggingComponent = _n0.a;
			return _Utils_eq(draggingComponent.id, id);
		} else {
			return false;
		}
	});
var author$project$Main$japanTimeZone = A2(elm$time$Time$customZone, 9 * 60, _List_Nil);
...
var author$project$Main$pad = function (text) {
	return A3(
...
var author$project$Main$time = F2(
	function (posix, timeZone) {
		return elm$core$String$fromInt(
			A2(elm$time$Time$toHour, timeZone, posix)) + (':' + (author$project$Main$pad(
			elm$core$String$fromInt(
				A2(elm$time$Time$toMinute, timeZone, posix))) + (':' + author$project$Main$pad(
			elm$core$String$fromInt(
				A2(elm$time$Time$toSecond, timeZone, posix))))));
	});
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$text('Japan Time')),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[mdgriffith$elm_ui$Element$centerX]),
							mdgriffith$elm_ui$Element$text(
								A2(author$project$Main$time, model.posix, author$project$Main$japanTimeZone)))
						]));
			case 'Clock':
				return A2(
					mdgriffith$elm_ui$Element$column,
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$text('UTC Time')),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[mdgriffith$elm_ui$Element$centerX]),
							mdgriffith$elm_ui$Element$text(
								A2(author$project$Main$time, model.posix, elm$time$Time$utc)))
						]));
			default:
				return A2(
					mdgriffith$elm_ui$Element$el,
					...
					A2(
						...
						_List_fromArray(
							[
								mdgriffith$elm_ui$Element$text(
								elm$core$Debug$toString(model.drag))
							])));
		}
	});
...
var author$project$Main$viewInnerComponent = F2(
	function (model, component) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					A2(author$project$Main$viewContent, model, component.content),
					A2(
					mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
					...
					mdgriffith$elm_ui$Element$text(component.id))
				]));
	});
...
var author$project$Main$viewComponentInDashboard = F2(
	function (model, component) {
		var isThisDragging_ = A2(author$project$Main$isComponentDragging, model, component.id);
		var isMouseOver = _Utils_eq(
			model.idComponentWithMouseOver,
			elm$core$Maybe$Just(component.id));
		return mdgriffith$elm_ui$Element$inFront(
			A2(
				mdgriffith$elm_ui$Element$el,
				_Utils_ap(
						...
						_Utils_ap(
							...
							_List_fromArray(
								[
									...
									mdgriffith$elm_ui$Element$htmlAttribute(
									A2(zaboco$elm_draggable$Draggable$mouseTrigger, component.id, author$project$Main$DragMsg)),
									mdgriffith$elm_ui$Element$htmlAttribute(
									elm$html$Html$Events$onMouseUp(
										author$project$Main$OnMouseDown(component.id))),
									mdgriffith$elm_ui$Element$htmlAttribute(
									A2(
										elm$html$Html$Attributes$style,
										'transform',
										'translate(' + (elm$core$String$fromInt(component.position.x) + ('px, ' + (elm$core$String$fromInt(component.position.y) + 'px)'))))),
									mdgriffith$elm_ui$Element$htmlAttribute(
									A2(
										elm$html$Html$Attributes$style,
										'z-index',
										isThisDragging_ ? '1' : 'auto')),
									mdgriffith$elm_ui$Element$Background$color(
									isMouseOver ? A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0.6, 0.6) : A3(mdgriffith$elm_ui$Element$rgb, 0.8, 0.8, 0.8)),
									...
									isMouseOver ? A2(
											...
											]),
										{
											...
											onPress: elm$core$Maybe$Just(
												author$project$Main$RemoveComponent(component.id))
										}) : mdgriffith$elm_ui$Element$none),
									mdgriffith$elm_ui$Element$htmlAttribute(
									A2(
										elm$html$Html$Attributes$style,
										'cursor',
										author$project$Main$isDragging(model) ? 'no-drop' : 'grab'))
								])))),
				A2(author$project$Main$viewInnerComponent, model, component)));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$htmlAttribute(
					A2(elm$html$Html$Attributes$style, 'transition', 'transform 0.05s, opacity 0.3s ease')),
					mdgriffith$elm_ui$Element$Background$color(
					A3(mdgriffith$elm_ui$Element$rgb, 0, 0.8, 0.5)),
					mdgriffith$elm_ui$Element$htmlAttribute(
					A2(zaboco$elm_draggable$Draggable$mouseTrigger, id, author$project$Main$DragMsg)),
					mdgriffith$elm_ui$Element$htmlAttribute(
					elm$html$Html$Events$onMouseUp(
						author$project$Main$OnMouseDown(id))),
					mdgriffith$elm_ui$Element$htmlAttribute(
					A2(
						elm$html$Html$Attributes$style,
						'transform',
...
var author$project$Main$addPointToMatrix = F2(
	function (_n0, matrix) {
		var x = _n0.a;
		var y = _n0.b;
		var id = _n0.c;
		var maybeRow = A2(elm$core$Array$get, y, matrix);
		if (maybeRow.$ === 'Just') {
			var row = maybeRow.a;
			var newRow = A3(elm$core$Array$set, x, id, row);
			return A3(elm$core$Array$set, y, newRow, matrix);
		} else {
			return matrix;
		}
	});
var author$project$Main$addPointsToMatrix = F2(
	function (matrix, points) {
		return A3(elm$core$List$foldl, author$project$Main$addPointToMatrix, matrix, points);
	});
...
var author$project$Main$componentToPoints = function (_n0) {
	var id = _n0.id;
	var size = _n0.size;
	return elm$core$List$concat(
		A2(
			...
			F2(
				function (indexX, _n1) {
					return A2(
						...
						F2(
							function (indexY, _n2) {
								return _Utils_Tuple3(indexX, indexY, id);
							}),
						A2(elm$core$List$repeat, size.y, _Utils_Tuple0));
				}),
			A2(elm$core$List$repeat, size.x, _Utils_Tuple0)));
};
var author$project$Main$movePoints = F2(
	function (_n0, deco) {
		...
		return A2(
			...
			function (_n1) {
				...
				var y_ = _n1.b;
				var id = _n1.c;
				return _Utils_Tuple3(x_ + position.x, y_ + position.y, id);
			},
			deco);
	});
var author$project$Main$addComponentToMatrix = F2(
	function (_n0, matrix) {
		...
		var size = _n0.size;
		return A2(
			author$project$Main$addPointsToMatrix,
			matrix,
			A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							mdgriffith$elm_ui$Element$padding(10),
							mdgriffith$elm_ui$Element$width(
							mdgriffith$elm_ui$Element$px(740)),
					...
					_List_fromArray(
						[
							author$project$Main$viewTest(model),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
							mdgriffith$elm_ui$Element$text(
								'· draggedComponent: ' + elm$core$Debug$toString(model.draggedComponent))),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
							mdgriffith$elm_ui$Element$text(
								'· isMouseUp: ' + elm$core$Debug$toString(model.isMouseUp))),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
							mdgriffith$elm_ui$Element$text(
								'· dragStartPosition: ' + elm$core$Debug$toString(model.dragStartPosition))),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
							mdgriffith$elm_ui$Element$text(
								'· drag: ' + elm$core$Debug$toString(model.drag))),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
							mdgriffith$elm_ui$Element$text(
								'· components quantity: ' + elm$core$Debug$toString(
									elm$core$List$length(model.components)))),
							A2(
							mdgriffith$elm_ui$Element$el,
							_List_Nil,
							mdgriffith$elm_ui$Element$text(
								'· idComponentWithMouseOver: ' + elm$core$Debug$toString(model.idComponentWithMouseOver))),
							A2(
							mdgriffith$elm_ui$Element$link,
							_List_Nil,
							{
								label: mdgriffith$elm_ui$Element$text('· Packery'),
								url: 'https://packery.metafizzy.co/'
							}),
							A2(
							mdgriffith$elm_ui$Element$link,
							_List_Nil,
							{
								label: mdgriffith$elm_ui$Element$text('· zaboco/elm-draggable'),
								url: 'https://package.elm-lang.org/packages/zaboco/elm-draggable/latest'
							})
						])) : mdgriffith$elm_ui$Element$none,
					A2(
					mdgriffith$elm_ui$Element$row,
						...
						[
							...
							_List_fromArray(
								[
									...
									mdgriffith$elm_ui$Element$inFront(
									author$project$Main$isDragging(model) ? A2(
										mdgriffith$elm_ui$Element$el,
										_List_fromArray(
											[
												mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
												...
												mdgriffith$elm_ui$Element$htmlAttribute(
												A2(elm$html$Html$Attributes$style, 'cursor', 'no-drop'))
											]),
							...
							A2(
								elm$core$List$map,
								function (component) {
									return A2(author$project$Main$viewComponentInMenu, model, component.id);
								},
								A2(
									elm$core$List$filter,
									function (c) {
										return _Utils_eq(c.location, author$project$Main$Menu);
									},
									model.components))),
							A2(
							mdgriffith$elm_ui$Element$el,
								...
								_Utils_ap(
									...
									_Utils_ap(
										A2(
											elm$core$List$map,
											function (component) {
												return A2(author$project$Main$viewComponentInDashboard, model, component);
											},
											A2(
												elm$core$List$filter,
												function (c) {
													return _Utils_eq(c.location, author$project$Main$Dashboard);
												},
												model.components)),
										_Utils_ap(
											A2(
												elm$core$List$map,
												function (component) {
													return A2(author$project$Main$viewComponentAsEmptyArea, model, component);
												},
												author$project$Main$componentsForEmpyAreas(model)),
											function () {
												var _n0 = author$project$Main$getOverlay(model);
												if (_n0.$ === 'Just') {
													var overlay = _n0.a;
													return _List_fromArray(
														[
															A2(author$project$Main$viewComponentAsOverlay, model, overlay)
														]);
												} else {
													return _List_Nil;
												}
