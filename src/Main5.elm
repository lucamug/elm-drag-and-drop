...
init _ =
    ( { components =
      ...
      , areas =
            [ { id = "Test 1", position = Position 0 0, size = Size 100 200 }
            , { id = "Test 2", position = Position 100 0, size = Size 100 100 }
            , { id = "Test 3", position = Position 200 0, size = Size 300 100 }
            , { id = "Test 4", position = Position 100 100, size = Size 200 200 }
            ]
      , drag = Draggable.init
      , isDragging = False
      , isMouseDown = ""
